#!/bin/sh
# descLinux-v5.sh — Detecta productos IBM instalados en un host Unix/Linux.
# Deriva de v4. Mejoras en v5:
#   - Tivoli Endpoint Manager / BigFix: BESClient
#   - Tivoli Workload Scheduler: conman
#   - UrbanCode Deploy: udclient
#   - WebSphere Message Broker: label en mqsilist para versiones viejas
#   - Cognos TM1 / Planning Analytics: tm1sd + tm1s
#   - WebSphere Enterprise Service Bus: wesbinstall (mejor esfuerzo)
#   - Informix SQL Development: isql
...
TMPDIR=${TMPDIR:-/tmp}
HALLAZGOS=$TMPDIR/descLinux-v5.$$.hits
RESULTADOS=$TMPDIR/descLinux-v5.$$.results
