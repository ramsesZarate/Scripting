#!/bin/sh
# descLinux-v3.sh — Detecta productos IBM instalados en un host Unix/Linux.
# Deriva de la base Linux estable y agrega detección conservadora para DataStage,
# Informix Enterprise Replication e Informix Storage Manager, sin modificar la
# lógica ya validada para los demás productos.
...
TMPDIR=${TMPDIR:-/tmp}
HALLAZGOS=$TMPDIR/descLinux-v3.$$.hits
RESULTADOS=$TMPDIR/descLinux-v3.$$.results
