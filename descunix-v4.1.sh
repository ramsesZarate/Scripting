#!/bin/sh
# descunix-v4.1.sh — Detecta productos IBM instalados en un host Unix/Linux.
...
TMPDIR=${TMPDIR:-/tmp}
HALLAZGOS=$TMPDIR/descunix-v4.1.$$.hits
GRUPOS=$TMPDIR/descunix-v4.1.$$.groups
VERSIONES=$TMPDIR/descunix-v4.1.$$.versions
