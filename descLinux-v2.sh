#!/bin/sh
# descLinux-v2.sh — Detecta productos IBM instalados en un host Unix/Linux.
# Deriva de la base Linux estable y agrega detección conservadora para DataStage,
# sin modificar la lógica ya validada para los demás productos.
...
TMPDIR=${TMPDIR:-/tmp}
HALLAZGOS=$TMPDIR/descLinux-v2.$$.hits
RESULTADOS=$TMPDIR/descLinux-v2.$$.results
